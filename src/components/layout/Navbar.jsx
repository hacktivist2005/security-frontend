      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-5 md:px-8 py-3.5 h-[68px]">
            ...
            <div className="flex items-center gap-2">
              <h1
                className={`text-xl font-black tracking-wider ${
                  darkMode
                    ? "bg-gradient-to-r from-white via-slate-200 to-green-400 bg-clip-text text-transparent"
                    : "text-slate-900"
                }`}
              >
                Cyber<span className="text-green-400">Trace</span>
              </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          {location.pathname === "/" ? (
            <a
              href="#hero"
              className="hidden md:inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-green-500 to-emerald-400 text-zinc-950 font-bold text-xs tracking-wide transition-transform hover:scale-105 shadow-[0_0_15px_rgba(74,222,128,0.3)]"
            >
